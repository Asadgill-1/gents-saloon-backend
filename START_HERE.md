...
| Phase 3 — Telegram and AI | **Customer and AI booking flows built; incomplete** | Complete reception/barber/owner/master callbacks, multilingual snapshots, 201-bot/live staging proof, adversarial matrix, and dated audit remain |
...
1. Replace each remaining Phase 3 placeholder callback with the complete reception/barber/owner/master transactional flow; customer and AI booking mutations already use the existing idempotent booking services.
