...
| Phase 3 — Telegram and AI | **Customer and reception operations built; incomplete** | Barber/owner/master callbacks, owner-side advance approval, multilingual snapshots, 201-bot/live staging proof, adversarial matrix, and dated audit remain |
...
1. Replace the barber/owner/master placeholders, including owner-side advance approval; customer booking, receptionist booking/walk-in/checkout/cash-shift/EOD/advance handoff, and AI booking mutations already use database-derived or idempotent domain services.
