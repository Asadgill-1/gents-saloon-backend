...
| Phase 3 — Telegram and AI | **Customer, reception, and barber operations built; incomplete** | Owner/master callbacks, owner-side advance approval, multilingual snapshots, 201-bot/live staging proof, adversarial matrix, and dated audit remain |
...
1. Replace the owner/master placeholders, including owner-side advance approval; customer, receptionist, barber, and AI booking paths already use database-derived or idempotent domain services.
