...
> Target architecture with implementation status through Phase 2 T2.5. Read [../START_HERE.md](../START_HERE.md) before assuming a later component exists.
...
- Advances and payout mutations remain later Phase 2 work.
