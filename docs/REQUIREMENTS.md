...
| BOT-03 | All required flows have button paths; AI outage degrades to buttons | Transactional customer and receptionist booking lifecycle built; remaining staff/owner/master operations and full Bot E2E open | partial |
